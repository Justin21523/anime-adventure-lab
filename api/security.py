...
Adapted from charaforge-T2I-Lab/api/security.py for anime-adventure-lab.
"""
...
if TYPE_CHECKING:
    from api.key_store import APIKeyStore  # noqa: F401
...
class RateLimiter:
    ...
    def _check_redis(
        ...
        redis_key = f"anime_adventure:ratelimit:{key}:{window_id}"
        try:
