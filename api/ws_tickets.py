...
Adapted from charaforge-T2I-Lab/api/ws_tickets.py for anime-adventure-lab.

Tickets are signed (HS256) and passed via ``Sec-WebSocket-Protocol`` to avoid
sending API keys / access tokens during the WebSocket handshake.
"""
